...
<body>
	<div id="wrapper" class="clearfix">
		<div id="top">
			<div id="header">
				<?php echo CHtml::link(CHtml::image(Yii::app()->request->baseUrl."/images/celesticXXX.png",CHtml::encode(Yii::app()->name).' v.'.Yii::app()->params['appVersion']),Yii::app()->createUrl('site'), array('title'=>CHtml::encode(Yii::app()->name).' v.'.Yii::app()->params['appVersion']));?>
					...
					if(!Yii::app()->user->isGuest)
					{
						...
						else
						{
							$items = array(
								...
								array('label'=>Yii::t('configuration', 'TitleConfiguration'), 'itemOptions'=>array('class'=>'mega megaleft'), 'linkOptions'=>array('class'=>'mega-link'), 'url'=>array('/configuration/admin'), 'visible'=>!Yii::app()->user->isGuest, 'active'=>(Yii::app()->controller->id=='configuration')),
							);
						}
		...
		<div id="footer">
			<div class="footerContent rounded">
				...
				<div class="mod footerRibbon">
					...
					Developed by <a href="http://qbit.com.mx" rel="external" title="VJ Ideas">VJ Ideas</a><br />
