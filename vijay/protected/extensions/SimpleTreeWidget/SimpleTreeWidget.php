...
class SimpleTreeWidget extends CInputWidget
{
    ...
    public $model;
    public $modelPropertyName = 'competency_technic';
    public $modelPropertyId = 'competency_id';
    public $modelPropertyParentId = 'competency_area';
   	public $modelPropertyPosition = 'competency_id';
