<div class="form">
	<?php
	$model=new Comments;
	echo "JMS this is comming from the listcomments view of the widgets";
	...
	<?php if(Yii::app()->user->hasFlash('CommentMessage')):?>
		<div class="info notification_error" id="CommentMessage">
			<p>JMS this div displays the image of the comment message and also the commentMessage... this is only displays if there are comments</p>
			<?php
	...
	<div class="row buttons" style="text-align:right; padding: 5px 10px 0 0;">
		...
		<?php
			echo CHtml::submitButton(Yii::t('site','commentxxxxsubmit'),array(
				'id'=>'lnkCommentSubmit',
